...
void square_conv_src (char let, char num) {
  if(num == '5' | num == '6' | num == '7' | num == '8')
    d5src = false; //corrected for row inversion
  else
    d5src = true; //corrected for row inversion
  if(num == '3' | num == '4' | num == '7' | num == '8')
    d4src = false; //corrected for row inversion
  else
    d4src = true; //corrected for row inversion
  if(num == '2' | num == '4' | num == '6' | num == '8')
    d3src = false; //corrected for row inversion
  else
    d3src = true; //corrected for row inversion
...
void square_conv_dst (char let, char num) {
  if(num == '5' | num == '6' | num == '7' | num == '8')
    d5dst = false; //corrected for row inversion
  else
    d5dst = true; //corrected for row inversion
  if(num == '3' | num == '4' | num == '7' | num == '8')
    d4dst = false; //corrected for row inversion
  else
    d4dst = true; //corrected for row inversion
  if(num == '2' | num == '4' | num == '6' | num == '8')
    d3dst = false; //corrected for row inversion
  else
    d3dst = true; //corrected for row inversion
  if(let == 'e' | let == 'f' | let == 'g' | let == 'h')
    d2dst = true;
  else
    d2dst = false;
