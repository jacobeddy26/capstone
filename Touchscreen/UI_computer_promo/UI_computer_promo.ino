/*
   Taylor Cox
   Chess UI: display computer promotion and ask for confirmation
   23 Jan - 2 Feb 2024
*/
...
void setup() {
  ...
  int cpu_promo_to = 1; // THIS VARIABLE WILL BE SET FROM ENGINE, HARDWIRED FOR TESTING ONLY (0-3)
  cpu_promo(cpu_promo_to); // HARDWIRED CALL FOR TESTING ONLY
}
